...
export default function OptionCard({ title, subtitle, icon, variant, onClick }: OptionCardProps) {
  const baseClasses = "group relative overflow-hidden rounded-2xl p-6 lg:p-10 cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        {/* Icon */}
        <div className={`text-5xl lg:text-7xl mb-6 lg:mb-8 transition-transform duration-300 group-hover:scale-110 ${
